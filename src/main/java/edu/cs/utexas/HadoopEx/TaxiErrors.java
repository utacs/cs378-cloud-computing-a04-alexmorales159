...
public class TaxiErrors extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new TaxiErrors(), args);
		System.exit(res);
	}
	...
	public int run(String args[]) {
		try {
			...
			job2.setJarByClass(TaxiErrors.class);

			// specify a Mapper
			job2.setMapperClass(TaxiTopKMapper.class);

			// specify a Reducer
			job2.setReducerClass(TaxiTopKReducer.class);
